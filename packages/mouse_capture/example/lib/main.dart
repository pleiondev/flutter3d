...
void main() {
  runApp(const MouseCaptureExample());
}

class MouseCaptureExample extends StatefulWidget {
  const MouseCaptureExample({super.key});

  @override
  State<MouseCaptureExample> createState() => _MouseCaptureExampleState();
}

class _MouseCaptureExampleState extends State<MouseCaptureExample>
    with SingleTickerProviderStateMixin {
  final MouseCapture _capture = MouseCapture.instance;
