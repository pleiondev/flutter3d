...
void main() {
  ...
  // `weapon_view.dart` is the renderer-facing half; `bridge.dart` itself
  // re-exports and names nothing, which is what a barrel should do.
  expectGenreIsolation(mayDraw: <String>{'lib/src/weapon_view.dart'});
