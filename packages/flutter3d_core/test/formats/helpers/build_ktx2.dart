...
/// cannot honour.
///
/// Kept in two copies deliberately: this one and
/// `flutter3d/test/helpers/build_ktx2.dart`. Both build the same bytes, but
/// `flutter3d`'s copy hands them to a device — that test cannot import a file
/// under a sibling package's `test/`, and `flutter3d_formats` cannot depend
/// on `flutter3d` to share it the other way round.
library;
