...
/// constant said 0.1.0 through two releases of the package, so every report
/// from those releases named a version that never existed.
library;
...
void main() {
  test('the server says the version its pubspec carries', () {
    ...
    expect(modelMcpVersion, declared);
  });
}
