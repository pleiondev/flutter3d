...
void main() {
  ...
  test('a cube, its top face found by name, extruded, with no blind call',
      () async {
  ...
  test('describe names specific elements when asked, and caps when not',
      () async {
  ...
  test('describing an object that is not there is an answer, not a crash',
      () async {
    expect(saidBy(await call('describe', <String, Object?>{'id': 99})),
