...
final class _CacheEntry {
  ...
  /// Which level-of-detail ratios the manifest asked for — `C5` — whether an
  /// impostor ends them — `C4` — and above how many triangles a mesh is split
  /// — `C9`. A rule that gains or changes either
