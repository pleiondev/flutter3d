...
///
/// Last recorded on 2026-09-25, Xcode 27.0, macOS 27.2, Apple silicon, after
/// the corrections the 0.8.0 validation found: the sun's normal offset no
/// longer overshooting, and the environment prefilter sampling its whole
/// lobe, which moved `directionalShadow` and `imageBasedLighting`. Before
/// that on 2026-09-24, with 0.7.4's shaders: the dither on by default, and the sun's normal offset
/// scaled by the cascade's texel, which moved one cell of
/// `directionalShadow` by 17. Before that on 2026-09-23, with the fallback
/// normal sending a normal scale of zero. That change moved `torchNearWall`
/// by a mean of 0.68 and every other scene by less than 0.35, and WebGL,
/// which had it already, read as a disagreement until then.
