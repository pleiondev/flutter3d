...
when the file names a generator — see the `level-document` skill. `save` with a
path writes there and the copy takes ownership of itself. Either way the answer
