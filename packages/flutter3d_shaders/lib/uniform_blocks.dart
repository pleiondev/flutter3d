...
uniformBlocks = <String, Map<String, Map<String, UniformMemberLayout>>>{
  ...
  'ImpostorVertex': <String, Map<String, UniformMemberLayout>>{
  ...
  'ParticleSixWaySoft': <String, Map<String, UniformMemberLayout>>{
    'ContributorLightInfo': <String, UniformMemberLayout>{
      'light_position': (
        offset: 0,
        byteLength: 128,
  ...
  'ParticleSoft': <String, Map<String, UniformMemberLayout>>{
    'FogInfo': <String, UniformMemberLayout>{
      'fog': (offset: 0, byteLength: 16, elements: 1, type: 'Vector4'),
      'eye': (offset: 16, byteLength: 16, elements: 1, type: 'Vector4'),
    },
  ...
  'PbrLayered': <String, Map<String, UniformMemberLayout>>{
    'FogInfo': <String, UniformMemberLayout>{
      'fog': (offset: 0, byteLength: 16, elements: 1, type: 'Vector4'),
      'eye': (offset: 16, byteLength: 16, elements: 1, type: 'Vector4'),
      'forward': (offset: 32, byteLength: 16, elements: 1, type: 'Vector4'),
