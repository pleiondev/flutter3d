...
/// the engine, and `tool/structure.dart`'s "the hardware layer names no
/// graphics API" rule says so for the layer below. So the caller makes the
/// renderer, from three values it no longer has to spell.
library;
