...
void main() {
  test('a solid block matches flutter3d_conformance\'s own reference bytes', () {
    ...
    expect(encoded[3] & 0x3, 0, reason: 'diff = 0, flip = 0 for a flat block');
  ...
  test('a wide-range block prefers differential when it fits, individual otherwise', () {
