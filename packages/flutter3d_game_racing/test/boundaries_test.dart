...
void main() {
  ...
  // `bridge.dart` is named rather than exempt by its name: the rule is a
  // list, and a second file needing a renderer should be a line added here
  // rather than a rename.
  expectGenreIsolation(mayDraw: <String>{'lib/bridge.dart'});
