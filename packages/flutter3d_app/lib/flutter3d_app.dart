...
///
/// Four packages exist because the wiring they hold was written out, close to
...
/// not a fifth re-export — `flutter3d_backend` merged in here by the
/// package-merge plan. The choice (`openDevice`) is a conditional export,
/// decided at compile time for native-vs-web, with a runtime `try`/`catch`
/// fallback to software on the native half if Impeller will not start — see
/// `backend_native.dart`/`backend_web.dart` for the whole of it.
///
/// None of the four re-exported packages know about each other, and this
