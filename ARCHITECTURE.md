...
| Unit tests | **3761 tests** across 24 packages and 5 applications |
| Structure rules | 30, `dart run tool/structure.dart`, the first CI step |
| CI | GitHub Actions over `tool/ci.sh`, on `ubuntu-latest`, with no graphics card |

**Golden render tests.** 42 scenes against **three independent reference sets** —
...
scene, all forty-two of them between 0.01% and 0.42%, measured rather than
...
**The web backend draws all forty-two golden scenes the way Impeller does**,
