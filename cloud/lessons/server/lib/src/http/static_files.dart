...
///
/// Copied from `cloud/server/lib/src/http/static_files.dart` rather than
/// shared — this package resolves its dependencies outside the workspace,
/// same as `cloud/server` itself, so there is nowhere in common to put a
/// shared file both could depend on without joining one service to the
/// other's release. In production nginx serves this directory directly; this
/// exists so one `dart run` is enough in development.
library;
