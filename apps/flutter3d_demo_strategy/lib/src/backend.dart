...
/// `flutter3d_backend`, which itself later folded into `flutter3d_app` by the
/// package-merge plan — reached through the barrel this file re-exports
/// rather than naming a backend package directly. What is left is the part
/// no two games share: the size this one draws at, and the shadow atlas it
/// can afford, when the backend renders to a fixed internal target.
library;
