...
This is modelled on `apps/flutter3d_demo_platformer/tool/prepare_models.py` instead, which does
...
def stamp(document, *, title: str, source: str) -> None:
    ...
    document.setdefault("asset", {})["extras"] = {
        ...
        "source": source,
        "modifiedBy": "apps/flutter3d_demo_dungeon/tool/prepare_monsters.py",
    }
