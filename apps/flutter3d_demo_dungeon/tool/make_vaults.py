...
TOOL = "apps/flutter3d_demo_dungeon/tool/make_vaults.py"
...
def build():
    ...
    k.monster("runner", (-22.0, 0.0, -12.0))
    k.monster("runner", (-17.0, 0.0, -4.0))
    ...
    k.monster("shooter", (20.0, 0.0, -15.0))
    k.monster("shooter", (24.0, 0.0, -2.0))
    k.monster("runner", (16.0, 0.0, -12.0))
