...
/// games; they live in `flutter3d_app` now — `flutter3d_backend`'s own code,
/// folded in by the package-merge plan — reached through the barrel this
/// file re-exports rather than naming a backend package directly. What stays
/// is what was never shared, and this game has more of it than the other
/// two: a smaller frame and a smaller shadow atlas in a browser.
library;
