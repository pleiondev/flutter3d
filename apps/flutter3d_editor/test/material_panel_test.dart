...
void main() {
  ...
  // `materialWith`'s own gate — a value outside a hint's ends, a write a
  // reader would only warn about, one it would silently swallow, a document
  // it could not open, a value already at the reader's default, and what an
  // accepted write keeps — moved to `flutter3d_editor_core/test/
  // material_edit_test.dart` alongside the function itself (mat-03).
}
