...
String toolLabel(AppLocalizations l, ModelerTool tool) => switch (tool.id) {
  ...
  'uv.select' => l.toolUvSelectLabel,
  'uv.markSeam' => l.toolUvMarkSeamLabel,
  'uv.clearSeam' => l.toolUvClearSeamLabel,
  'uv.unwrap' => l.toolUvUnwrapLabel,
  'uv.pack' => l.toolUvPackLabel,
  ...
  'retopo.quad' => l.toolRetopoQuadLabel,
  'retopo.auto' => l.toolRetopoAutoLabel,
  'retopo.bake' => l.toolRetopoBakeLabel,
  'paint.brush' => l.toolPaintBrushLabel,
  'paint.fill' => l.toolPaintFillLabel,
  'paint.clear' => l.toolPaintClearLabel,
  'sim.select' => l.toolSimSelectLabel,
  'sim.pin' => l.toolSimPinLabel,
  'sim.bake' => l.toolSimBakeLabel,
  'render.snapshot' => l.toolRenderSnapshotLabel,
  'render.save' => l.toolRenderSaveLabel,
  _ => tool.label,
};
...
String toolAbout(AppLocalizations l, ModelerTool tool) => switch (tool.id) {
  ...
  'uv.select' => l.toolUvSelectAbout,
  'uv.markSeam' => l.toolUvMarkSeamAbout,
  'uv.clearSeam' => l.toolUvClearSeamAbout,
  'uv.unwrap' => l.toolUvUnwrapAbout,
  'uv.pack' => l.toolUvPackAbout,
  ...
  'retopo.quad' => l.toolRetopoQuadAbout,
  'retopo.auto' => l.toolRetopoAutoAbout,
  'retopo.bake' => l.toolRetopoBakeAbout,
  'paint.brush' => l.toolPaintBrushAbout,
  'paint.fill' => l.toolPaintFillAbout,
  'paint.clear' => l.toolPaintClearAbout,
  'sim.select' => l.toolSimSelectAbout,
  'sim.pin' => l.toolSimPinAbout,
  'sim.bake' => l.toolSimBakeAbout,
  'render.snapshot' => l.toolRenderSnapshotAbout,
  'render.save' => l.toolRenderSaveAbout,
  _ => tool.about,
};
