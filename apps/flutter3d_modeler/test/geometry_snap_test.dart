...
void main() {
  group('findSnapTarget', () {
    ...
    test('nothing within reach answers null rather than the nearest anything', () {
      final other = EditMesh.cuboid(size: Vector3(2.0, 2.0, 2.0));
    ...
    test(
      'view-26n\'s own acceptance: a face is offered when neither a vertex '
    ...
    test('the radius is measured in the object it is asked of, not the world', () {
      ...
      final other = EditMesh.cuboid(size: Vector3(2.0, 2.0, 2.0));
      final objectToWorld = Matrix4.identity()..scaleByVector3(Vector3.all(5.0));
      final source = SnapSource(
        id: 1,
        picker: pickerFor(other),
        objectToWorld: objectToWorld,
