...
void main() {
  ...
  testWidgets('the two profiles are both offered under New project', (
    WidgetTester tester,
  ) async {
    await _open(tester);
  ...
  testWidgets('picking a profile closes the dialog with that choice', (
    WidgetTester tester,
  ) async {
    await tester.pumpWidget(
      _app(
  ...
  testWidgets('with no recent files, the section is not shown at all', (
    WidgetTester tester,
  ) async {
    await _open(tester);
  ...
  testWidgets('a recent path is offered by its own last segment', (
    WidgetTester tester,
  ) async {
    await _open(
      tester,
