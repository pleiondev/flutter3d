...
3697 tests across 24 packages and five applications, and only about thirty need a GPU: the Impeller half of the golden set. The other half renders through the software backend, so forty-one scenes stay checkable in a headless run.
