...
6211 tests across 34 packages and seven applications, and only about thirty need a GPU: the Impeller half of the golden set. The other half renders through the software backend, so forty-three scenes stay checkable in a headless run.
