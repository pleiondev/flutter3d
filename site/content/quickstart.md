...
3539 tests across 24 packages and five applications, and only about thirty need a GPU: the Impeller half of the golden set. The other half renders through the software backend, so thirty-nine scenes stay checkable in a headless run.
