...
6. A presenter widget for the new backend, and a `presentFrame` arm in `flutter3d_app` that returns it — in whatever way your platform actually composites.
