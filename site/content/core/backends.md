...
<li>The forty-one shader entry points your bundle must answer to</li>
</ul>
</div>
...
| Post | `BloomThreshold`, `BloomDownsample`, `BloomUpsample`, `Composite`, `Fxaa`, `Reflections`, `Ssao`, `SsaoBlur`, `Luminance`, `ProbePrefilter` |
