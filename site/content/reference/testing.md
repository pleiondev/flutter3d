...
| `flutter3d_cpu` | 181 | | `flutter3d_session` | 34 |
...
| `flutter3d_game` | 79 | | `flutter3d_game_strategy` | 13 |
| `flutter3d_shaders` | 1 | | | |

The rows sum to 3797 rather than 3812: the remaining 15 live in `packages/*/example/test`, which the count includes and this table does not.
