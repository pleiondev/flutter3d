...
| `flutter3d_cpu` | 209 | | `apps/flutter3d_demo_strategy` | 42 |
| `apps/flutter3d_editor` | 174 | | `flutter3d_session` | 54 |
...
| `flutter3d_model_core` | 693 | | `flutter3d_model_mcp` | 67 |

The rows sum to 6333 rather than 6352: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
