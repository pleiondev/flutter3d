...
| `flutter3d_cpu` | 299 | | `apps/flutter3d_demo_strategy` | 50 |
...
The rows sum to 10447 rather than 10471: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not, among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
