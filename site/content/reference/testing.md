...
| `flutter3d_model_core` | 222 | | | |

The rows sum to 5192 rather than 5211: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
