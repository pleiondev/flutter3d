...
| `flutter3d_cpu` | 209 | | `apps/flutter3d_demo_strategy` | 43 |
| `apps/flutter3d_editor` | 174 | | `flutter3d_session` | 57 |
...
| `flutter3d_model_core` | 695 | | `flutter3d_model_mcp` | 67 |
| | | | `flutter3d_net` | 14 |
| | | | `flutter3d_net_webrtc` | 2 |
| | | | `flutter3d_sim_mcp` | 7 |

The rows sum to 6409 rather than 6428: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
