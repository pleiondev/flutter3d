---
description: Three independent golden sets and a fourth being recorded, mutation-checking every new test, determinism and snapshots, and why only about thirty of 5967 tests need a GPU.
---
...
The rows sum to 5948 rather than 5967: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
