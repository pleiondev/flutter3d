...
| `flutter3d_model_core` | 377 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5479 rather than 5498: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
