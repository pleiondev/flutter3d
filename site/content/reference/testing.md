...
| `flutter3d_model_core` | 240 | | | |

The rows sum to 5211 rather than 5230: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
