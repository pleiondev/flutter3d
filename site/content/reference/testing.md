...
| `flutter3d_physics` | 168 | | `flutter3d_webgpu` | 154 |
...
The rows sum to 4282 rather than 4301: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
