...
| `flutter3d_model_core` | 534 | | `flutter3d_model_mcp` | 49 |

The rows sum to 5714 rather than 5733: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
