...
| `flutter3d_model_core` | 183 | | | |

The rows sum to 5143 rather than 5162: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
