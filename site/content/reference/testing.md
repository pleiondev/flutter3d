...
| `flutter3d_twin` | 4 | | `apps/flutter3d_lab_pendulum` | 4 |
...
The rows sum to 7434 rather than 7453: the remaining live in `packages/*/example/test`, which the count includes and this table does not — the usual 19 plus whatever a concurrent session's own in-flight work has added there since this snapshot was taken.
