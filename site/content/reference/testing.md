...
| `flutter3d_model_core` | 646 | | `flutter3d_model_mcp` | 61 |

The rows sum to 6068 rather than 6087: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
