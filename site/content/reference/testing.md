...
| `flutter3d_model_core` | 417 | | `flutter3d_model_mcp` | 19 |

The rows sum to 5567 rather than 5586: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
