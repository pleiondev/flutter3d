...
| `flutter3d_physics` | 168 | | `flutter3d_webgpu` | 163 |
...
The rows sum to 4291 rather than 4310: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
