...
| `flutter3d_physics` | 168 | | `flutter3d_webgpu` | 63 |
...
The rows sum to 4187 rather than 4206: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
