...
| `flutter3d_game_racing` | 223 | | `flutter3d_webgl` | 59 |
...
The rows sum to 10441 rather than 10465: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not, among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
