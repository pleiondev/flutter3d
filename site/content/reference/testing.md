...
| `flutter3d_model_core` | 474 | | `flutter3d_model_mcp` | 19 |

The rows sum to 5624 rather than 5643: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
