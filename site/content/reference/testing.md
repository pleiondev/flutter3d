...
| `flutter3d_model_core` | 507 | | `flutter3d_model_mcp` | 21 |

The rows sum to 5659 rather than 5678: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
