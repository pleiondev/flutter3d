...
| `flutter3d_model_core` | 590 | | `flutter3d_model_mcp` | 54 |

The rows sum to 5904 rather than 5923: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
