...
| `apps/flutter3d_editor` | 182 | | `flutter3d_session` | 64 |
...
| `apps/flutter3d_demo_dungeon` | 95 | | `flutter3d_backend` | 4 |
...
The rows sum to 6448 rather than 6467: the remaining live in `packages/*/example/test`, which the count includes and this table does not — the usual 19 plus whatever a concurrent session's own in-flight work has added there since this snapshot was taken.
