...
| `flutter3d_model_core` | 604 | | `flutter3d_model_mcp` | 54 |

The rows sum to 5934 rather than 5953: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
