...
| `flutter3d_model_core` | 614 | | `flutter3d_model_mcp` | 58 |

The rows sum to 5953 rather than 5972: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
