...
| `flutter3d_model_core` | 228 | | | |

The rows sum to 5199 rather than 5218: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
