...
| `flutter3d_cpu` | 108 | | `apps/flutter3d_demo_strategy` | 43 |
...
The rows sum to 9024 rather than 9048: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not — among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
