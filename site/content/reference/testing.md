...
| `flutter3d_model_core` | 357 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5459 rather than 5478: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
