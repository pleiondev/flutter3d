...
| `apps/flutter3d_demo_dungeon` | 110 | | `flutter3d_app` | 112 |
...
The rows sum to 9418 rather than 9442: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not — among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
