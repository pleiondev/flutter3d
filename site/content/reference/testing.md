...
| `flutter3d_model_core` | 411 | | `flutter3d_model_mcp` | 19 |

The rows sum to 5561 rather than 5580: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
