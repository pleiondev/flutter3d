...
| `apps/flutter3d_demo_racing` | 147 | | `pointer_lock` | 28 |
...
| `apps/flutter3d_demo_dungeon` | 93 | | `flutter3d_backend` | 4 |
...
The rows sum to 6360 rather than 6379: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
