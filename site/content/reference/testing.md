...
| `flutter3d_model_core` | 279 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5341 rather than 5360: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
