...
| `flutter3d_lab` | 10 | | `flutter3d_core` | 539 |
...
| `flutter3d_cpu` | 117 | | `apps/flutter3d_demo_strategy` | 50 |
...
| `flutter3d_flame` | 47 | | `apps/flutter3d_showcase` | 60 |

The rows sum to 9724 rather than 9748: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not — among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
