...
| `flutter3d_game_racing` | 212 | | `flutter3d_impeller` | 53 |
...
The rows sum to 3601 rather than 3616: the remaining 15 live in `packages/*/example/test`, which the count includes and this table does not.
