...
| `flutter3d_model_core` | 529 | | `flutter3d_model_mcp` | 41 |

The rows sum to 5701 rather than 5720: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
