...
| `flutter3d_cpu` | 176 | | `flutter3d_session` | 34 |
...
The rows sum to 3765 rather than 3780: the remaining 15 live in `packages/*/example/test`, which the count includes and this table does not.
