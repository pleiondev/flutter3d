...
| `flutter3d_model_core` | 596 | | `flutter3d_model_mcp` | 54 |

The rows sum to 5926 rather than 5945: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
