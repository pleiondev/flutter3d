...
| `flutter3d_sim` | 543 | | `pad_input` | 59 |
| `flutter3d_lab` | 15 | | `flutter3d_core` | 543 |
...
| `apps/flutter3d_demo_platformer` | 199 | | `flutter3d_impeller` | 59 |
| `flutter3d_cpu` | 124 | | `apps/flutter3d_demo_strategy` | 50 |
| `apps/flutter3d_editor` | 213 | | `apps/flutter3d_demo_arcade` | 8 |
| `apps/flutter3d_demo_racing` | 162 | | `pointer_lock` | 28 |
| `flutter3d_physics` | 173 | | `flutter3d_webgpu` | 180 |
...
The rows sum to 9824 rather than 9848: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not, among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
