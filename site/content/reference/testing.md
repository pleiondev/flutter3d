...
| `flutter3d_model_core` | 150 | | | |

The rows sum to 5069 rather than 5088: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
