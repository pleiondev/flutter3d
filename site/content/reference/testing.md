...
| `flutter3d_physics` | 168 | | `flutter3d_webgpu` | 28 |
...
The rows sum to 4152 rather than 4171: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
