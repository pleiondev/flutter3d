...
| `flutter3d_cpu` | 206 | | `apps/flutter3d_demo_strategy` | 42 |
| `apps/flutter3d_editor` | 163 | | `flutter3d_session` | 43 |
...
| `flutter3d_screens` | 125 | | `flutter3d_testing` | 10 |
...
| `flutter3d_model_core` | 652 | | `flutter3d_model_mcp` | 67 |

The rows sum to 6178 rather than 6197: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
