...
| `flutter3d_game_racing` | 223 | | `flutter3d_webgl` | 54 |
| `flutter3d_game_platformer` | 217 | | `flutter3d_hardware` | 53 |
...
| `flutter3d_physics` | 168 | | `flutter3d_webgpu` | 16 |
...
The rows sum to 4140 rather than 4159: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
