...
| `flutter3d_model_core` | 245 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5298 rather than 5317: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
