...
| `flutter3d_game_platformer` | 205 | | `flutter3d_webgl` | 53 |
...
The rows sum to 3652 rather than 3667: the remaining 15 live in `packages/*/example/test`, which the count includes and this table does not.
