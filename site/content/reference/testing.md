...
| `flutter3d_model_core` | 674 | | `flutter3d_model_mcp` | 67 |

The rows sum to 6229 rather than 6248: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
