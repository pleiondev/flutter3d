...
| `flutter3d_cpu` | 186 | | `flutter3d_impeller` | 53 |
...
The rows sum to 4103 rather than 4122: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
