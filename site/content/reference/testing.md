...
| `flutter3d_model_core` | 259 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5312 rather than 5331: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
