...
| `flutter3d_model_core` | 345 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5447 rather than 5466: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
