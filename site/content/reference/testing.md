...
| `flutter3d_model_core` | 515 | | `flutter3d_model_mcp` | 23 |

The rows sum to 5669 rather than 5688: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
