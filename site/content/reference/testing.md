...
| `flutter3d_lti` | 26 | | `apps/flutter3d_lab_pendulum` | 4 |
...
| `apps/flutter3d_demo_racing` | 158 | | `pointer_lock` | 28 |
...
| `flutter3d_particles` | 75 | | `flutter3d_stereo` | 48 |
...
The rows sum to 9793 rather than 9817: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not — among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
