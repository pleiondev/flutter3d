...
| `flutter3d_model_core` | 618 | | `flutter3d_model_mcp` | 58 |

The rows sum to 5957 rather than 5976: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
