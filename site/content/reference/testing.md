...
| `flutter3d_cpu` | 200 | | `apps/flutter3d_demo_strategy` | 42 |
...
The rows sum to 6148 rather than 6167: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
