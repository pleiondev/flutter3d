...
| `flutter3d_physics` | 168 | | `flutter3d_webgpu` | 112 |
...
The rows sum to 4238 rather than 4257: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
