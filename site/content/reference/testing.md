...
| `apps/flutter3d_demo_dungeon` | 108 | | `flutter3d_backend` | 4 |
...
| `flutter3d_render_job` | 8 | | `flutter3d_sim_mcp` | 9 |
| `flutter3d_mcp_kit` | 1 | | `flutter3d_build` | 78 |
...
The rows sum to 7495 rather than 7514: the remaining live in `packages/*/example/test`, which the count includes and this table does not — the usual 19 plus whatever a concurrent session's own in-flight work has added there since this snapshot was taken.
