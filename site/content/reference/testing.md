...
| `flutter3d_model_core` | 585 | | `flutter3d_model_mcp` | 54 |

The rows sum to 5899 rather than 5918: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
