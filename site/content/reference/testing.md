...
| `flutter3d_model_core` | 199 | | | |

The rows sum to 5169 rather than 5188: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
