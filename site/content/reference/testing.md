...
| `flutter3d_mcp_kit` | 1 | | `flutter3d_build` | 76 |
...
The rows sum to 7486 rather than 7505: the remaining live in `packages/*/example/test`, which the count includes and this table does not — the usual 19 plus whatever a concurrent session's own in-flight work has added there since this snapshot was taken.
