...
| `flutter3d_model_core` | 283 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5345 rather than 5364: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
