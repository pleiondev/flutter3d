...
| `flutter3d_model_core` | 155 | | | |

The rows sum to 5074 rather than 5093: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
