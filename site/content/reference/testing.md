...
| `flutter3d_game` | 79 | | `flutter3d_game_strategy` | 19 |
| `flutter3d_shaders` | 1 | | | |

The rows sum to 3803 rather than 3822: the remaining 15 live in `packages/*/example/test`, which the count includes and this table does not.
