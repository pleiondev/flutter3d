---
description: Three independent golden sets and a fourth being recorded, mutation-checking every new test, determinism and snapshots, and why only about thirty of 5443 tests need a GPU.
---
...
| `flutter3d_model_core` | 322 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5424 rather than 5443: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
