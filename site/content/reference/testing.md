---
description: Three independent golden sets and a fourth being recorded, mutation-checking every new test, determinism and snapshots, and why only about thirty of 5705 tests need a GPU.
---
...
| `flutter3d_model_core` | 529 | | `flutter3d_model_mcp` | 26 |

The rows sum to 5686 rather than 5705: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
