...
| `flutter3d_model_core` | 220 | | | |

The rows sum to 5190 rather than 5209: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
