...
| `flutter3d_model_core` | 579 | | `flutter3d_model_mcp` | 54 |

The rows sum to 5886 rather than 5905: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
