...
| `flutter3d_physics` | 168 | | `flutter3d_webgpu` | 117 |
...
The rows sum to 4243 rather than 4262: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
