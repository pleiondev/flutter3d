...
| `flutter3d_game_platformer` | 191 | | `flutter3d_webgl` | 53 |
...
The rows sum to 3562 rather than 3577: the remaining 15 live in `packages/*/example/test`, which the count includes and this table does not.
