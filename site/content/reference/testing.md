...
| `flutter3d_game` | 79 | | `flutter3d_game_strategy` | 35 |
| `flutter3d_shaders` | 1 | | `apps/flutter3d_demo_strategy` | 1 |

The rows sum to 3831 rather than 3850: the remaining 15 live in `packages/*/example/test`, which the count includes and this table does not.
