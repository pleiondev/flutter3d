...
| `apps/flutter3d_demo_platformer` | 192 | | `flutter3d_hardware` | 52 |
...
The rows sum to 3380 rather than 3393: the remaining 13 live in `packages/*/example/test`, which the count includes and this table does not.
