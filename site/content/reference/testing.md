...
| `flutter3d_physics` | 168 | | `flutter3d_webgpu` | 75 |
...
The rows sum to 4201 rather than 4220: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
