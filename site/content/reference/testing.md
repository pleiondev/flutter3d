...
| `flutter3d_cpu` | 193 | | `apps/flutter3d_demo_strategy` | 42 |
...
| `flutter3d_screens` | 125 | | `flutter3d_testing` | 7 |
...
| `flutter3d_particles` | 73 | | `flutter3d_stereo` | 24 |
| `flutter3d_model_core` | 534 | | `flutter3d_model_mcp` | 54 |

The rows sum to 5758 rather than 5777: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
