...
| `apps/flutter3d_demo_platformer` | 199 | | `flutter3d_impeller` | 60 |
...
The rows sum to 9827 rather than 9851: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not — among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
