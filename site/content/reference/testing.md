...
| `flutter3d_model_core` | 160 | | | |

The rows sum to 5079 rather than 5098: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
