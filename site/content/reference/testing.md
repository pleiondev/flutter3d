...
| `flutter3d_game_platformer` | 198 | | `flutter3d_webgl` | 53 |
...
The rows sum to 3603 rather than 3618: the remaining 15 live in `packages/*/example/test`, which the count includes and this table does not.
