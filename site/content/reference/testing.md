...
| `flutter3d_model_core` | 530 | | `flutter3d_model_mcp` | 47 |

The rows sum to 5708 rather than 5727: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
