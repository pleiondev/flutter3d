...
| `flutter3d_model_core` | 626 | | `flutter3d_model_mcp` | 58 |

The rows sum to 5966 rather than 5985: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
