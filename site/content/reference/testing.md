...
| `apps/flutter3d_editor` | 163 | | `flutter3d_session` | 54 |
...
The rows sum to 6312 rather than 6331: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
