...
| `flutter3d_game` | 253 | | `flutter3d_shaders` | 1 |
...
The rows sum to 9848 rather than 9872: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not, among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
