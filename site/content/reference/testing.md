...
| `flutter3d_model_core` | 599 | | `flutter3d_model_mcp` | 54 |

The rows sum to 5929 rather than 5948: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
