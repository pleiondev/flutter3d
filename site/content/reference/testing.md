...
| `flutter3d_model_core` | 499 | | `flutter3d_model_mcp` | 19 |

The rows sum to 5649 rather than 5668: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
