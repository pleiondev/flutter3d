...
| `flutter3d_model_core` | 139 | | | |

The rows sum to 5047 rather than 5066: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
