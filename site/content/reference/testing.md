...
| `flutter3d_game` | 79 | | `flutter3d_game_strategy` | 55 |
| `flutter3d_shaders` | 1 | | `apps/flutter3d_demo_strategy` | 1 |

The rows sum to 3851 rather than 3870: the remaining 15 live in `packages/*/example/test`, which the count includes and this table does not.
