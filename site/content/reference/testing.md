...
| `apps/flutter3d_editor` | 182 | | `flutter3d_session` | 66 |
...
The rows sum to 6480 rather than 6499: the remaining live in `packages/*/example/test`, which the count includes and this table does not — the usual 19 plus whatever a concurrent session's own in-flight work has added there since this snapshot was taken.
