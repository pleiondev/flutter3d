...
| `flutter3d_model_core` | 267 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5329 rather than 5348: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
