...
| `flutter3d_model_core` | 574 | | `flutter3d_model_mcp` | 54 |

The rows sum to 5871 rather than 5890: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
