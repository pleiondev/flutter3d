...
| `flutter3d_model_core` | 206 | | | |

The rows sum to 5176 rather than 5195: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
