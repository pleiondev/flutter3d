...
| `flutter3d_model_core` | 126 | | | |

The rows sum to 5026 rather than 5045: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
