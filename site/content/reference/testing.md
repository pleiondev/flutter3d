...
| `flutter3d_cpu` | 71 | | `apps/flutter3d_demo_strategy` | 43 |
...
| `flutter3d_model_core` | 797 | | `flutter3d_model_mcp` | 91 |
| | | | `flutter3d_net` | 14 |
...
The rows sum to 7404 rather than 7423: the remaining live in `packages/*/example/test`, which the count includes and this table does not — the usual 19 plus whatever a concurrent session's own in-flight work has added there since this snapshot was taken.
