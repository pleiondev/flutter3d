...
| `flutter3d_model_core` | 235 | | | |

The rows sum to 5206 rather than 5225: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
