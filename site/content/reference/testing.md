...
| `flutter3d_model_core` | 173 | | | |

The rows sum to 5108 rather than 5127: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
