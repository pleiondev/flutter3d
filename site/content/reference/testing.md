...
| `apps/flutter3d_editor` | 170 | | `flutter3d_session` | 54 |
...
The rows sum to 6324 rather than 6343: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
