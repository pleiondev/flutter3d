...
| `flutter3d_model_core` | 191 | | | |

The rows sum to 5161 rather than 5180: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
