...
| `flutter3d_model_core` | 797 | | `flutter3d_model_mcp` | 93 |
| | | | `flutter3d_net` | 14 |
...
The rows sum to 7407 rather than 7426: the remaining live in `packages/*/example/test`, which the count includes and this table does not — the usual 19 plus whatever a concurrent session's own in-flight work has added there since this snapshot was taken.
