...
| `flutter3d_physics` | 182 | | `flutter3d_webgpu` | 193 |
...
The rows sum to 10448 rather than 10472: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not, among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
