...
| `flutter3d_lab` | 10 | | `flutter3d_core` | 543 |
...
The rows sum to 9788 rather than 9812: the remaining 24 live in `packages/*/example/test`, which the count includes and this table does not — among them the two seeds a new project starts from, `packages/flutter3d_app/example` and `packages/flutter3d_game/example`.
