...
| `flutter3d_physics` | 168 | | `flutter3d_webgpu` | 156 |
...
The rows sum to 4284 rather than 4303: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
