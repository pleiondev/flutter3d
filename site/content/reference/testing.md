...
| `flutter3d_model_core` | 241 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5256 rather than 5275: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
