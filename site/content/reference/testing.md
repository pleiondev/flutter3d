...
| `flutter3d_model_core` | 320 | | `flutter3d_model_mcp` | 16 |

The rows sum to 5404 rather than 5423: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
