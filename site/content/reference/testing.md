...
| `flutter3d_cpu` | 207 | | `apps/flutter3d_demo_strategy` | 42 |
...
The rows sum to 6191 rather than 6210: the remaining 19 live in `packages/*/example/test`, which the count includes and this table does not.
