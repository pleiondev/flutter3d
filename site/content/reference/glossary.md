...
<dl class="keys">
  ...
  <div><dt>Structure rule</dt><dd>One of twenty-nine scans in <code>tool/structure.dart</code>. They read source text and hold the architecture: that a genre package stays out of another genre, that the documents' numbers are true</dd></div>
</dl>
