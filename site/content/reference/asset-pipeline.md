...
The hook is told which platform it is building for, and takes the family that platform guarantees — a fact about the platform, not a guess about a device:
