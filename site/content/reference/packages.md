...
The detectors prove they fire before a single file is scanned, and a broken detector stops the run rather than letting twenty-nine green scans be reported behind it. See [Testing](/reference/testing/).
