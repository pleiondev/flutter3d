...
| ux-52 | **The agent drives Play**: `play.start {template}`, `play.reload`, `play.stop`, `play.console`, `play.screenshot` | mcp + app | S | Play | ux-51, ux-44 | an agent starts Play, changes a material, reloads, and gets a screenshot where the colour changed |
