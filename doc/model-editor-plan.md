...
| ux-49 | **An HDR or EXR panorama as the environment** (comparison §2.8), beside the four presets | app + formats | M | P2 | ux-23 | a 2:1 `.hdr` lights a sphere differently from a preset (a frame test); an image that isn't 2:1 refuses naming its size |
