...
| gal-05 | **The export carries what a licence demands**: an item under CC-BY writes its attribution into the exported file's own metadata and into a `CREDITS.txt` beside it, named per model. CC0 writes nothing, which is the point of preferring it | app + core | M | P2 | gal-04, ux-18 | a project with one CC-BY model exports with that credit and no other; an all-CC0 project exports no credits file |
