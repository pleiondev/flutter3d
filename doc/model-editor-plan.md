...
| ux-34 | **Contrast** (review §6.3): the sheet handle and track tone (`outlineVariant` on `surfaceContainerLow`, 1.94:1) reaches 3:1; the orientation dial's 9 px label on X+ (4.38:1) reaches 4.5:1 | app | S | P2 | ux-32 | a contrast test computes both pairs from the theme and fails below the thresholds |
