...
| ux-35 | ⇢ ux-43. The review's small MCP cleanups: drop `addShape`, the duplicate of `addShapeFromMesh`; enums in `ui.*`; `bloomEnabled` declared in the schema | mcp | S | P2 | ux-43 | see ux-43 |
