...
| ux-48 | **Import as a link** (comparison §2.9). "Link to source" keeps the path and a hash; "Re-import" replaces the mesh and keeps transforms, materials and modifiers | app + core | M | P2 | ux-06 | re-importing a changed OBJ updates its vertices and keeps the object's transform and modifier stack |
