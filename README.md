...
2948 tests across nineteen packages, and the only ones that need a GPU are the
...
So `dart run tool/structure.dart` checks it: one of its nineteen rules compares
