...
3697 tests across twenty-four packages and five applications, and the only
...
So `dart run tool/structure.dart` checks it: one of its twenty-nine rules compares
