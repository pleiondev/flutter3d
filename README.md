...
9029 tests across thirty-six packages and eight applications, and the only
...
So `dart run tool/structure.dart` checks it: one of its thirty-three rules compares
