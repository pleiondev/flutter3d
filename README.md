...
3616 tests across twenty-four packages and five applications, and the only
...
So `dart run tool/structure.dart` checks it: one of its twenty-eight rules compares
